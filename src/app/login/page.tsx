...
export default function LoginPage() {
  ...
  const handleGoogleLogin = async () => {
    setError('Google sign-in is currently disabled for security. Please use email/password login.')
    // Commented out for security - only pre-approved accounts can access admin
