...
const figureFilters = [
  {
    ...
    options: [
      ...
      { id: 'Good Smile Company', name: 'Good Smile Company' },
      { id: 'Kotobukiya', name: 'Kotobukiya' },
      { id: 'MegaHouse', name: 'MegaHouse' },
...
export default async function FiguresPage(props: FiguresPageProps) {
              ...
              <Sheet>
                ...
                <SheetContent side="left" className="w-[85vw] sm:w-[400px] overflow-y-auto bg-white p-6">
                  ...
                  <Suspense fallback={null}>
                    <CategoryPageFilters basePath="/figures" isMobile extraFilters={figureFilters} />
                  </Suspense>
                </SheetContent>
              </Sheet>
            </div>
