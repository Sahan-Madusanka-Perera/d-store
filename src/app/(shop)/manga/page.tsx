...
export default async function MangaPage(props: MangaPageProps) {
  ...
  if (search) {
    query = query.or(buildSearchFilter(search, 'manga'));
  }
        ...
        <div className="flex flex-col items-center text-center mb-16 md:mb-20">
          ...
          <div className="flex flex-wrap justify-center gap-4 sm:gap-6 mt-12 w-full">
            <div className="flex flex-col items-center justify-center bg-card border border-border rounded-2xl py-6 px-10 shadow-sm min-w-[160px]">
              ...
              <div className="text-xs text-muted-foreground font-semibold uppercase tracking-widest">Titles</div>
            </div>
            <div className="flex flex-col items-center justify-center bg-card border border-border rounded-2xl py-6 px-10 shadow-sm min-w-[160px]">
              <div className="text-4xl font-black text-foreground tracking-tight pb-1">Latest</div>
              <div className="text-xs text-muted-foreground font-semibold uppercase tracking-widest">Releases</div>
            </div>
            <div className="flex flex-col items-center justify-center bg-card border border-border rounded-2xl py-6 px-10 shadow-sm min-w-[160px]">
              <div className="text-4xl font-black text-foreground tracking-tight pb-1">Top</div>
              <div className="text-xs text-muted-foreground font-semibold uppercase tracking-widest">Sellers</div>
            </div>
          </div>
        </div>
          ...
          <div className="flex-1 w-full">
            ...
            {products.length > 0 ? (
              ...
              <div className="flex flex-col items-center justify-center py-24 px-4 bg-card border border-border rounded-3xl shadow-sm text-center">
                ...
                <h2 className="text-2xl sm:text-3xl font-bold text-foreground tracking-tight mb-3">No Manga Found</h2>
