  ...
  return (
    <div className="flex flex-col sm:flex-row items-stretch gap-4 w-full">
      ...
      <Button
        ...
        className="flex-1 h-14 text-base font-black uppercase tracking-wide rounded-xl bg-primary text-primary-foreground hover:bg-primary/90 transition-all duration-300 active:scale-[0.98]"
      >
